...
Through vizualizations data exploration was performed. In the dashboard, useful insights were found. For consultation Tableau Public Link: 

https://public.tableau.com/app/profile/bibiana6825/viz/DropoutPredictionStory/Story2?publish=yes

Below, some of the insights are discribed.

- The following visualization shows that nationality is not a determinant factor for the analysis. Therefore, it was dropped from the dataframe before Machine Learning Models analysis. 
